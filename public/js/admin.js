...
// PRD v4.4.4: Added auth + admin role checks
...
(async function() {
  ...
  if (!user.admin_configured) {
    ...
    document.body.innerHTML = `
      <div style="display: flex; align-items: center; justify-content: center; height: 100vh; flex-direction: column; font-family: system-ui; text-align: center;">
        <h1 style="color: #fa0; margin-bottom: 1rem;">Admin Not Configured</h1>
    ...
    pendingAnalytes.forEach(analyte => {
      ...
      row.innerHTML = `
        ...
        <td class="actions-cell">
          ...
          <button class="action-btn details-btn" data-id="${analyte.pending_id}">Details</button>
        </td>
      `;
