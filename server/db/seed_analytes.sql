...
INSERT INTO analytes (code, name, unit_canonical) VALUES
  ...
  ('AFP', 'Alpha-Fetoprotein (AFP)', 'IU/mL'),
  ('AI', 'Atherogenic Index (Atherogenicity Index)', ''),
  ('APOA1', 'Apolipoprotein A1', 'г/л'),
  ('APOB', 'Apolipoprotein B', 'г/л'),
  ('APOB_APOA1', 'Apolipoprotein B / Apolipoprotein A1 Ratio', ''),
  ('APTT', 'Activated Partial Thromboplastin Time (APTT)', 'сек'),
  ('APTT_RATIO', 'APTT Ratio', ''),
  ('ASLO', 'Antistreptolysin O (ASO) / Antistreptolysin O titer', 'МЕ/мл'),
  ('BASO', 'Basophils (absolute)', '10^9 клеток/л'),
  ('BASO_PRCT', 'Basophils (%)', '%'),
  ('C_PEPTIDE', 'C-Peptide', 'нг/мл'),
  ('C3', 'Complement C3', 'г/л'),
  ('C4', 'Complement C4', 'г/л'),
  ('CA_ION', 'Ionized Calcium', 'ммоль/л'),
  ('CA125', 'Cancer Antigen 125 (CA 125)', 'U/mL'),
  ('CA19_9', 'Cancer Antigen 19-9 (CA 19-9)', 'U/mL'),
  ('CA72_4', 'Cancer Antigen 72-4 (CA 72-4)', 'U/mL'),
  ('CALCITONIN', 'Calcitonin', 'pg/ml'),
  ('CANDIDA_SPP', 'Candida species (fungi) (culture/microbiology identification)', ''),
  ('CD19', 'CD19+ B-lymphocytes (absolute, 10^9/L)', '10^9 клеток/л'),
  ('CD19_PRCT', 'CD19+ B-lymphocytes (%)', '%'),
  ('CD3', 'CD3+ T-lymphocytes (absolute, 10^9/L)', '10^9 клеток/л'),
  ('CD3_HLA_DR', 'CD3+ HLA-DR+ T-lymphocytes (absolute, 10^9/L)', '10^9 клеток/л'),
  ('CD3_HLA_DR_PRCT', 'CD3+ HLA-DR+ T-lymphocytes (%)', '%'),
  ('CD3_PRCT', 'CD3+ T-lymphocytes (%)', '%'),
  ('CD4', 'CD3+CD4+ T-helpers (absolute, 10^9/L)', '10^9 клеток/л'),
  ('CD4_CD8_RATIO', 'CD4+/CD8+ Lymphocyte Ratio', ''),
  ('CD4_PRCT', 'CD3+CD4+ T-helpers (%)', '%'),
  ('CD8', 'CD3+CD8+ Cytotoxic T-lymphocytes (absolute, 10^9/L)', '10^9 клеток/л'),
  ('CD8_PRCT', 'CD3+CD8+ Cytotoxic T-lymphocytes (%)', '%'),
  ('CEA', 'Carcinoembryonic Antigen (CEA)', 'ng/mL'),
  ('CL_ION', 'Ionized Chloride', 'ммоль/л'),
  ('CMV_IGG', 'Cytomegalovirus IgG Antibody', 'Ед/мл'),
  ('CMV_IGM', 'Cytomegalovirus IgM Antibody', 'Индекс'),
  ('COAG_END', 'Clotting time - end / coagulation end', ''),
  ('COAG_START', 'Clotting time - start / coagulation start', ''),
  ('CORT', 'Cortisol', 'нмоль/л'),
  ('D_DIMER', 'D-dimer', 'нг/мл DDU'),
  ('DOPAMINE', 'Dopamine', 'пг/мл'),
  ...
  ('EO', 'Eosinophils (absolute)', '10^9 клеток/л'),
  ('EO_PRCT', 'Eosinophils (%)', '%'),
  ('EBV_NA_IGG', 'Epstein-Barr Virus Nuclear Antigen (EBV-NA) IgG Antibody', 'Ед'),
  ('EBV_VCA_IGA', 'Epstein-Barr Virus VCA IgA Antibody', 'Ед/мл'),
  ('EBV_VCA_IGG', 'Epstein-Barr Virus VCA IgG Antibody', 'Ед/мл'),
  ('EBV_VCA_IGM', 'Epstein-Barr Virus VCA IgM Antibody', 'R'),
  ('FIBRINOGEN', 'Fibrinogen', 'г/л'),
  ('HBsAG', 'Hepatitis B surface antigen (HBsAg), qualitative', ''),
  ('HCV_IGG', 'Hepatitis C Virus Antibodies (Anti-HCV), qualitative', 'Индекс'),
  ('HIV_ANTIBODY', 'HIV Antibodies (screening), qualitative', ''),
  ('HOMA_IR', 'HOMA-IR (Homeostatic Model Assessment of Insulin Resistance)', ''),
  ('HSV1_IGG', 'Herpes Simplex Virus Type 1 IgG Antibody', 'Ед/мл'),
  ('HSV2_IGG', 'Herpes Simplex Virus Type 2 IgG Antibody', 'Ед/мл'),
  ('IBIL', 'Indirect Bilirubin (Unconjugated Bilirubin)', 'мкмоль/л'),
  ('IG_A', 'Immunoglobulin A (IgA)', 'г/л'),
  ('IG_E', 'Total Immunoglobulin E (IgE)', 'МЕ/мл'),
  ('IG_G', 'Immunoglobulin G (IgG)', 'г/л'),
  ('IG_M', 'Immunoglobulin M (IgM)', 'г/л'),
  ('INR', 'International Normalized Ratio (INR)', ''),
  ('INSULIN', 'Insulin', 'пмоль/л'),
  ('K_ION', 'Ionized Potassium', 'ммоль/л'),
  ('LPA', 'Lipoprotein(a)', 'г/л'),
  ('LUC', 'Large Unstained Cells (absolute)', '10^9 клеток/л'),
  ('LUC_PRCT', 'Large Unstained Cells (%)', '%'),
  ('LYMPH', 'Lymphocytes (absolute)', '10^9 клеток/л'),
  ('LYMPH_PRCT', 'Lymphocytes (%)', '%'),
  ('MICROFLORA_GROWTH', 'Microflora growth (culture result: growth of flora)', ''),
  ('MONO', 'Monocytes (absolute)', '10^9 клеток/л'),
  ('MONO_PRCT', 'Monocytes (%)', '%'),
  ('NA_ION', 'Ionized Sodium', 'ммоль/л'),
  ('NEISSERIA_SUBFLAVA', 'Neisseria subflava (microbial identification)', ''),
  ('NEUT', 'Neutrophils (absolute)', '10^9 клеток/л'),
  ('NEUT_BAND_PRCT', 'Band Neutrophils (%)', '%'),
  ('NEUT_PRCT', 'Neutrophils (%)', '%'),
  ('NK', 'NK cells (CD3-CD16+CD56+) (absolute, 10^9/L)', '10^9 клеток/л'),
  ('NK_PRCT', 'NK cells (CD3-CD16+CD56+) (%)', '%'),
  ('NKT', 'NKT cells (CD3+CD16+CD56+) (absolute, 10^9/L)', '10^9 клеток/л'),
  ...
  ('NOREPINEPHRINE', 'Norepinephrine (Noradrenaline)', 'пг/мл'),
  ('NSE', 'Neuron-Specific Enolase (NSE)', 'ng/mL'),
  ('P_LCR', 'Platelet Large Cell Ratio (P-LCR)', '%'),
  ('PCT', 'Plateletcrit (PCT)', '%'),
  ('PCTN', 'Procalcitonin', 'нг/мл'),
  ('PDW', 'Platelet Distribution Width (PDW)', '%'),
  ('PROTHROMBIN_ACTIVITY', 'Prothrombin activity (% by Quick method)', '%'),
  ('PT', 'Prothrombin Time (PT)', 'сек'),
  ('RHEUMATOID_FACTOR', 'Rheumatoid Factor', 'МЕ/мл'),
  ('SARS2_IGG', 'SARS-CoV-2 IgG Antibody', ''),
  ('SARS2_IGG_N', 'SARS-CoV-2 Nucleocapsid IgG Antibody (semiquantitative, ELISA)', 'КП'),
  ('SARS2_IGG_S', 'SARS-CoV-2 Spike (S) Protein IgG Antibody (semiquantitative, ELISA)', 'КП'),
  ...
  ('TESTOSTERONE_TOTAL', 'Total Testosterone', 'нмоль/л'),
  ('TG', 'Thyroglobulin (TG)', 'ng/mL'),
  ('THROMBIN_TIME', 'Thrombin Time (TT)', 'сек'),
  ('THROMBIN_TIME_RATIO', 'Thrombin Time Ratio', ''),
  ('TOXO_IGG', 'Toxoplasma gondii IgG Antibody', 'МЕ/мл'),
  ('TOXO_IGM', 'Toxoplasma gondii IgM Antibody', 'Индекс'),
  ('TPO_AB', 'Thyroid Peroxidase Antibodies (TPO Ab)', 'МЕ/мл'),
  ('URINE_AMMONIUM_BIURATE', 'Urine Ammonium Biurate Crystals', ''),
  ('URINE_BACTERIA', 'Urine Bacteria (microscopy)', ''),
  ('URINE_BIL', 'Urine Bilirubin', 'мг/дл'),
  ('URINE_CALCIUM_PHOSPHATE_CRYSTALS', 'Urine Calcium Phosphate Crystals', ''),
  ('URINE_CASTS', 'Urine Casts (cylinders)', 'в п/зр.'),
  ('URINE_CASTS_HYALINE', 'Hyaline casts (urine)', 'ед/мкл'),
  ('URINE_CASTS_NON_HYALINE', 'Non-hyaline Urine Casts', 'ед/мкл'),
  ('URINE_COLOR', 'Urine Color', ''),
  ('URINE_CRYSTALS', 'Urine Crystals / Salts', ''),
  ('URINE_CRYSTALS_OXALATE', 'Urine Calcium Oxalate Crystals', 'ед/мкл'),
  ('URINE_CULTURE_AB_SENS', 'Urine Bacterial Culture with Antibiotic Sensitivity', ''),
  ('URINE_EPIT', 'Urine Epithelial Cells (sediment)', ''),
  ('URINE_EPIT_NONPLAT', 'Urine Non-squamous Epithelial Cells (sediment)', 'ед/мкл'),
  ('URINE_EPIT_PLAT', 'Urine Squamous Epithelial Cells (sediment)', 'в п/зр.'),
  ('URINE_EPIT_RENAL', 'Urine Renal (Renal Tubular) Epithelial Cells (sediment)', 'в п/зр.'),
  ('URINE_EPIT_TRANS', 'Urine Transitional Epithelial Cells (sediment)', 'в п/зр.'),
  ('URINE_GLUC', 'Urine Glucose', 'мг/дл'),
  ('URINE_HGB', 'Urine Hemoglobin', 'мг/дл'),
  ('URINE_INTACT_RBC', 'Urine Intact (Non-lysed) Red Blood Cells', 'ед/мкл'),
  ('URINE_KET', 'Urine Ketones', 'мг/дл'),
  ('URINE_LEUKOCYTE_ESTERASE', 'Urine Leukocyte Esterase', ''),
  ('URINE_MUCUS', 'Urine Mucus (sediment)', ''),
  ('URINE_MUCUS_SED', 'Mucus (urine sediment)', 'ед/мкл'),
  ('URINE_NIT', 'Urine Nitrites', ''),
  ('URINE_NORMAL_FLORA', 'Normal Flora (urine culture/microscopy)', ''),
  ('URINE_PH', 'Urine pH', ''),
  ('URINE_PROT', 'Urine Protein', 'мг/дл'),
  ('URINE_RBC', 'Urine Red Blood Cells', 'ед/мкл'),
  ('URINE_RBC_HGB', 'Urine Red Blood Cells and Hemoglobin (urine haematuria/hemoglobin)', 'мг/л'),
  ('URINE_SED_RBC', 'Urine Sediment Erythrocytes', ''),
  ('URINE_SED_WBC', 'Urine Sediment Leukocytes', ''),
  ('URINE_SG', 'Urine Specific Gravity', ''),
  ('URINE_SPERM', 'Spermatozoa in Urine (sediment)', 'ед/мкл'),
  ('URINE_TRIPLE_PHOSPHATE_CRYSTALS', 'Urine Triple Phosphate (Struvite) Crystals', ''),
  ('URINE_TURBIDITY', 'Urine Transparency/Turbidity', ''),
  ('URINE_UBG', 'Urine Urobilinogen', 'мг/дл'),
  ('URINE_URATES', 'Urine Urate Crystals', ''),
  ('URINE_URIC_ACID_CRYSTALS', 'Urine Uric Acid Crystals', ''),
  ('URINE_UROBILIN', 'Urine Urobilin', 'мкмоль/л'),
  ('URINE_WBC', 'Urine Leukocytes (WBC)', 'ед/мкл'),
  ('URINE_WBC_CLUSTERS', 'Urine Leukocyte Aggregates / WBC Clusters (urine sediment)', 'ед/мкл'),
  ('URINE_YEAST', 'Urine Yeast (fungi, microscopy)', 'ед/мкл')
